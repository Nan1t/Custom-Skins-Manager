/**
 * PacketWrapper - ProtocolLib ru.csm.bukkit.wrappers for Minecraft packets
 ...
 */
package ru.csm.bukkit.wrappers;
...
public class OldWrapperPlayServerSpawnEntityLiving extends AbstractPacket {
	public static final PacketType TYPE = PacketType.Play.Server.SPAWN_ENTITY_LIVING;

	private static PacketConstructor entityConstructor;

	public OldWrapperPlayServerSpawnEntityLiving() {
		super(new PacketContainer(TYPE), TYPE);
		handle.getModifier().writeDefaults();
	}

	public OldWrapperPlayServerSpawnEntityLiving(PacketContainer packet) {
		super(packet, TYPE);
	}

	public OldWrapperPlayServerSpawnEntityLiving(Entity entity) {
