...
import ru.csm.bukkit.wrappers.WrapperPlayServerEntityHeadRotation;
import ru.csm.bukkit.wrappers.WrapperPlayServerNamedEntitySpawn;
import ru.csm.bukkit.wrappers.WrapperPlayServerPlayerInfo;
...
public class NPC_1_10 implements NPC{
    ...
    public NPC_1_10(UUID uuid, String name){
        this.uuid = uuid;
        this.name = name;
