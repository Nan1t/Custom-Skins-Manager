...
public class SimpleMySQLDatabase implements Database {

    private Connection connection;

    public SimpleMySQLDatabase(String url, int port, String database, String user, String password) throws SQLException {
        connection = DriverManager.getConnection("jdbc:mysql://" + url + ":" + port + "/" + database + "?characterEncoding=utf8", user, password);
    }
